<?php
  ...
  Auth::redirect_if_not_allowed(["user_list"]);
  ...
  $template_parameters['data']['table'] = DataTable::create($User->to_datatable($list));

  $template_parameters['page_subtitle']  = TranslationHelper::get_text("page_subtitle_user");
  $template_parameters['page_title'] = TranslationHelper::get_text("page_title_user");
  ...
  $template_parameters['buttons'] = [
    ...
    [
      ...
      "html" => "
        ...
        data-modal_text=\"Convidar Usuário\" 
        data-api=\"user\" 
        data-api_action=\"get_form\" 
        data-mode=\"invite_user\" 
        data-confirm=\"required\"         
        data-confirm_parameters='" . json_encode(["title" => TranslationHelper::get_text("confirm_invite_title"), "html" => TranslationHelper::get_text("confirm_invite_text"), "icon" => "question"], true) . "'    
          data-method=\"POST\"
          data-reload=\"true\"
          data-hide_form=\"true\"
        >
